...
//		fileName = "None";
	...
	/**
	 * copy filename from another picture
	 */
	public void copyFilenameFromPicture(SimplePicture SP) {
		this.fileName = SP.fileName;
		this.extension = SP.extension;
	}
	...
	public void copyPicture(SimplePicture sourcePicture) {
		...
		this.copyFilenameFromPicture(sourcePicture);
	}
	...
	public Pixel getPixel(int x, int y) {
		...
		if (x > this.getWidth() || y > this.getHeight()){
			String errorMsg = "\n\nError message provided by CS60 staff :-)" 
					+ "\nYour code attempted to access a pixel outside of the Picture\n"
					+ "The picture has width: " + this.getWidth() 
					+ " and height: " + this.getHeight() 
					+ "\nbut tried to access x=" + x + " and y=" + y 
					+ "\nClick on the links within Picture.java below to see what line the error was on!" 
					+ "\n******* Yo! - Please read the error message above! *******";
